...
class SolutionOne(Scene):
    ...
    def construct(self):
        ...
        five_sixth.next_to(equal, RIGHT, MED_LARGE_BUFF)
        one_sixth.next_to(five_sixth, RIGHT)
        ...
        one_sixth.next_to(five_sixth_2, RIGHT,)
        ...
        highlight_rect = Rectangle(fill_opacity=.7, fill_color=BLACK, width=2, height=1)
        highlight_rect.move_to(rhs).shift(DOWN/7)
